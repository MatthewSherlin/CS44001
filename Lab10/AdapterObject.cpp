...
public:
   ...
   adaptee_.topLeftX_ = topLeftX;
   adaptee_.topLeftY_ = topLeftY;
   adaptee_.bottomRightX_ = bottomRightX;
   adaptee_.bottomRightY = bottomRightY;
   }
...
int main(){
   Figure *square = new SquareAdapter(15);
   square->draw();
}
